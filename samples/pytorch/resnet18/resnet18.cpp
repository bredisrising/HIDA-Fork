...
void forward_node0(
  ...
  for (int v35 = 0; v35 < 8000; v35 += 1) {	// L107
    ...
    forward_node2(v30, v38, v37, v36);	// L111
    forward_node1(v32, v38, v31, v34, v33, v37, v36);	// L112
  }
}
...
void forward_node9(
  ...
  for (int v93 = 0; v93 < 8; v93 += 1) {	// L170
    for (int v94 = 0; v94 < 8; v94 += 2) {	// L171
      ...
      if ((((-v93) + (v92 * -8)) + 511) == 0 && ((-v91) + 2) == 0 && ((-v90) + 2) == 0) {	// L184
        v88[v94] = v105;	// L185
      }
      ...
      if ((((-v93) + (v92 * -8)) + 511) == 0 && ((-v91) + 2) == 0 && ((-v90) + 2) == 0) {	// L198
        v88[(v94 + 1)] = v115;	// L199
      }
    }
  }
...
void forward_node6(
  ...
  for (int v155 = 0; v155 < 1806336; v155 += 1) {	// L238
    ...
    forward_node12(v151, v165, v160, v159, v158, v161);	// L251
    forward_node11(v152, v164, v157, v156, v158);	// L252
    forward_node10(v149, v163, v157, v156, v158);	// L253
    float v167[8];	// L254
    ...
    forward_node9(v163, v166, v165, v164, v162, v167, v159, v160, v161);	// L255
...
void forward_node16(
  ...
  for (int v183 = 0; v183 < 8; v183 += 1) {	// L270
    for (int v184 = 0; v184 < 8; v184 += 2) {	// L271
      #pragma HLS pipeline II=1
      float v185 = v175[v184];	// L272
      float v186 = v178[v184];	// L273
      float v187 = v179[v184];	// L274
      float v188 = (v183 == 0) ? v186 : v187;	// L275
      float v189 = ((v183 + (v181 * 8)) == 0 && v180 == 0 && v182 == 0) ? v185 : v188;	// L276
      float v190 = v176[v183];	// L277
      float v191 = v177[v184][v183];	// L278
      ...
      float v196 = ((((-v183) + (v181 * -8)) + 511) == 0 && ((-v180) + 2) == 0 && ((-v182) + 2) == 0) ? v195 : v193;	// L283
      v179[v184] = v196;	// L284
      float v197 = v175[(v184 + 1)];	// L285
      float v198 = v178[(v184 + 1)];	// L286
      float v199 = v179[(v184 + 1)];	// L287
      float v200 = (v183 == 0) ? v198 : v199;	// L288
      float v201 = ((v183 + (v181 * 8)) == 0 && v180 == 0 && v182 == 0) ? v197 : v200;	// L289
      float v202 = v177[(v184 + 1)][v183];	// L290
      ...
      float v207 = ((((-v183) + (v181 * -8)) + 511) == 0 && ((-v180) + 2) == 0 && ((-v182) + 2) == 0) ? v206 : v204;	// L295
...
void forward_node14(
  ...
  for (int v246 = 0; v246 < 1806336; v246 += 1) {	// L334
    ...
    forward_node20(v243, v256, v248, v247, v249);	// L345
    forward_node19(v244, v255, v248, v247, v249);	// L346
    forward_node18(v242, v254, v252, v248, v251, v247, v250);	// L347
    forward_node17(v241, v253, v251, v250, v249, v252);	// L348
    float v257[8];	// L349
    ...
    forward_node16(v256, v254, v253, v255, v257, v251, v252, v250);	// L350
...
void forward_node21(
  ...
  for (int v350 = 0; v350 < 100352; v350 += 1) {	// L450
    ...
    forward_node29(v345, v360, v352, v351, v353);	// L461
    forward_node28(v347, v359, v352, v351, v353);	// L462
    forward_node27(v346, v358, v354, v352, v351);	// L463
    forward_node26(v343, v357, v353, v354);	// L464
    forward_node25(v344, v356, v352, v351, v353);	// L465
    float v361[8];	// L466
    ...
    forward_node24(v357, v358, v360, v356, v359, v355, v361, v354);	// L467
    forward_node23(v361, v349, v352, v351, v353);	// L468
    forward_node22(v355, v348, v352, v351, v353);	// L469
  }
}
...
void forward_node30(
  ...
  for (int v434 = 0; v434 < 1806336; v434 += 1) {	// L539
    ...
    forward_node36(v431, v444, v436, v435, v437);	// L550
    forward_node35(v432, v443, v436, v435, v437);	// L551
    forward_node34(v429, v442, v440, v436, v439, v435, v438);	// L552
    forward_node33(v430, v441, v439, v438, v437, v440);	// L553
    float v445[8];	// L554
...
void forward_node39(
  ...
  for (int v461 = 0; v461 < 8; v461 += 1) {	// L569
    for (int v462 = 0; v462 < 8; v462 += 2) {	// L570
      ...
      float v467 = ((v461 + (v459 * 8)) == 0 && v460 == 0 && v458 == 0) ? v463 : v466;	// L575
      float v468 = v453[v461];	// L576
      float v469 = v454[v462][v461];	// L577
      ...
      float v474 = ((((-v461) + (v459 * -8)) + 255) == 0 && ((-v460) + 2) == 0 && ((-v458) + 2) == 0) ? v473 : v471;	// L582
      v457[v462] = v474;	// L583
      float v475 = v455[(v462 + 1)];	// L584
      float v476 = v456[(v462 + 1)];	// L585
      float v477 = v457[(v462 + 1)];	// L586
      float v478 = (v461 == 0) ? v476 : v477;	// L587
      float v479 = ((v461 + (v459 * 8)) == 0 && v460 == 0 && v458 == 0) ? v475 : v478;	// L588
      float v480 = v454[(v462 + 1)][v461];	// L589
      ...
      float v485 = ((((-v461) + (v459 * -8)) + 255) == 0 && ((-v460) + 2) == 0 && ((-v458) + 2) == 0) ? v484 : v482;	// L594
...
void forward_node37(
  float v519[512][256][3][3],
  float v520[512][7][7],
  float v521[256][14][14],
  float v522[512][7][7],
  float v523[512][7][7]
) {	// L632
  for (int v524 = 0; v524 < 903168; v524 += 1) {	// L633
    ...
    forward_node41(v521, v532, v530, v526, v529, v525, v528);	// L646
    forward_node40(v519, v531, v529, v528, v527, v530);	// L647
    float v535[8];	// L648
    ...
    forward_node39(v532, v531, v534, v533, v535, v528, v530, v529);	// L649
...
void forward_node44(
  float v626[256][256][3][3],
  float v627[256][14][14],
  ...
  for (int v632 = 0; v632 < 36864; v632 += 1) {	// L760
    ...
    forward_node51(v628, v643, v638, v637, v634, v636, v633);	// L772
    forward_node50(v626, v642, v637, v636, v635, v638);	// L773
    forward_node49(v629, v641, v635, v634, v633);	// L774
    forward_node48(v627, v640, v635, v634, v633);	// L775
    ...
    forward_node47(v643, v640, v642, v641, v644, v639, v637, v638, v636);	// L777
    forward_node46(v644, v630, v635, v634, v633);	// L778
    forward_node45(v639, v631, v635, v634, v633);	// L779
  }
}
    ...
    for (int v663 = 0; v663 < 8; v663 += 2) {	// L797
      for (int v664 = 0; v664 < 7; v664 += 1) {	// L798
        for (int v665 = 0; v665 < 7; v665 += 1) {	// L799
          #pragma HLS pipeline II=1
          float v666 = v656[v663][v664][v665];	// L800
          ...
          float v672 = v655[v663][v662];	// L806
          ...
          float v678 = v656[(v663 + 1)][v664][v665];	// L813
          ...
          float v683 = v655[(v663 + 1)][v662];	// L818
...
void forward_node52(
  ...
  for (int v732 = 0; v732 < 36864; v732 += 1) {	// L874
    ...
    forward_node54(v740, v739, v742, v741, v743, v737, v736, v738);	// L890
    ...
    for (int v771 = 0; v771 < 8; v771 += 2) {	// L920
      for (int v772 = 0; v772 < 7; v772 += 1) {	// L921
        for (int v773 = 0; v773 < 7; v773 += 1) {	// L922
          #pragma HLS pipeline II=1
          float v774 = v762[v771][v772][v773];	// L923
          float v775 = v766[v771][v772][v773];	// L924
          float v776 = v767[v771][v772][v773];	// L925
          float v777 = (v770 == 0) ? v775 : v776;	// L926
          float v778 = ((v770 + (v769 * 8)) == 0) ? v774 : v777;	// L927
          float v779 = v765[v770][v772][v773];	// L928
          float v780 = v764[v771][v770];	// L929
          float v781 = v779 * v780;	// L930
          float v782 = v778 + v781;	// L931
          v767[v771][v772][v773] = v782;	// L932
          float v783 = v763[v771][v772][v773];	// L933
          ...
          if ((((-v770) + (v769 * -8)) + 127) == 0) {	// L937
            v768[v771][v772][v773] = v786;	// L938
          }
          float v787 = v762[(v771 + 1)][v772][v773];	// L940
          float v788 = v766[(v771 + 1)][v772][v773];	// L941
          float v789 = v767[(v771 + 1)][v772][v773];	// L942
          float v790 = (v770 == 0) ? v788 : v789;	// L943
          float v791 = ((v770 + (v769 * 8)) == 0) ? v787 : v790;	// L944
          float v792 = v764[(v771 + 1)][v770];	// L945
          float v793 = v779 * v792;	// L946
          float v794 = v791 + v793;	// L947
          v767[(v771 + 1)][v772][v773] = v794;	// L948
          float v795 = v763[(v771 + 1)][v772][v773];	// L949
          ...
          if ((((-v770) + (v769 * -8)) + 127) == 0) {	// L953
            v768[(v771 + 1)][v772][v773] = v798;	// L954
          }
        }
      }
    }
...
void forward_node59(
  ...
  for (int v849 = 0; v849 < 2048; v849 += 1) {	// L1016
    ...
    forward_node62(v859, v855, v856, v857, v858, v860, v854, v853);	// L1033
...
void forward_node68(
  float v937[256][256][3][3],
  float v938[256][14][14],
  ...
  for (int v942 = 0; v942 < 36864; v942 += 1) {	// L1123
    ...
    forward_node74(v938, v952, v945, v944, v943);	// L1134
    forward_node73(v940, v951, v945, v944, v943);	// L1135
    forward_node72(v939, v950, v948, v947, v944, v946, v943);	// L1136
    forward_node71(v937, v949, v947, v946, v945, v948);	// L1137
    ...
    forward_node70(v949, v950, v952, v951, v953, v946, v948, v947);	// L1139
    ...
    for (int v972 = 0; v972 < 8; v972 += 2) {	// L1158
      for (int v973 = 0; v973 < 7; v973 += 1) {	// L1159
        for (int v974 = 0; v974 < 7; v974 += 1) {	// L1160
          #pragma HLS pipeline II=1
          float v975 = v964[v972][v973][v974];	// L1161
          float v976 = v966[v972][v973][v974];	// L1162
          float v977 = v967[v972][v973][v974];	// L1163
          float v978 = (v971 == 0) ? v976 : v977;	// L1164
          float v979 = ((v971 + (v970 * 8)) == 0 && v969 == 0 && v968 == 0) ? v975 : v978;	// L1165
          float v980 = v963[v971][v973][v974];	// L1166
          ...
          float v986 = ((((-v971) + (v970 * -8)) + 127) == 0 && ((-v969) + 2) == 0 && ((-v968) + 2) == 0) ? v985 : v983;	// L1172
          v967[v972][v973][v974] = v986;	// L1173
          float v987 = v964[(v972 + 1)][v973][v974];	// L1174
          float v988 = v966[(v972 + 1)][v973][v974];	// L1175
          float v989 = v967[(v972 + 1)][v973][v974];	// L1176
          float v990 = (v971 == 0) ? v988 : v989;	// L1177
          float v991 = ((v971 + (v970 * 8)) == 0 && v969 == 0 && v968 == 0) ? v987 : v990;	// L1178
          ...
          float v997 = ((((-v971) + (v970 * -8)) + 127) == 0 && ((-v969) + 2) == 0 && ((-v968) + 2) == 0) ? v996 : v994;	// L1184
...
void forward_node75(
  float v1036[256][14][14],
  float v1037[128][28][28],
  float v1038[256][128][3][3],
  ...
  for (int v1041 = 0; v1041 < 18432; v1041 += 1) {	// L1235
    ...
    forward_node81(v1036, v1051, v1044, v1043, v1042);	// L1246
    forward_node80(v1039, v1050, v1044, v1043, v1042);	// L1247
    forward_node79(v1037, v1049, v1047, v1046, v1043, v1045, v1042);	// L1248
    forward_node78(v1038, v1048, v1046, v1045, v1044, v1047);	// L1249
    ...
    forward_node77(v1049, v1051, v1048, v1050, v1052, v1045, v1046, v1047);	// L1251
    ...
    for (int v1081 = 0; v1081 < 8; v1081 += 2) {	// L1281
      for (int v1082 = 0; v1082 < 7; v1082 += 1) {	// L1282
        for (int v1083 = 0; v1083 < 7; v1083 += 1) {	// L1283
          ...
          if ((((-v1080) + (v1079 * -8)) + 127) == 0 && ((-v1077) + 2) == 0 && ((-v1078) + 2) == 0) {	// L1296
          ...
          if ((((-v1080) + (v1079 * -8)) + 127) == 0 && ((-v1077) + 2) == 0 && ((-v1078) + 2) == 0) {	// L1310
...
void forward_node82(
  ...
  float v1144[128][128][3][3],
  float v1145[128][28][28],
  ...
  for (int v1149 = 0; v1149 < 36864; v1149 += 1) {	// L1362
    ...
    forward_node89(v1143, v1160, v1155, v1154, v1151, v1153, v1150);	// L1374
    forward_node88(v1144, v1159, v1154, v1153, v1152, v1155);	// L1375
    forward_node87(v1146, v1158, v1152, v1151, v1150);	// L1376
    forward_node86(v1145, v1157, v1152, v1151, v1150);	// L1377
    ...
    forward_node85(v1160, v1159, v1157, v1158, v1156, v1161, v1154, v1153, v1155);	// L1379
    forward_node84(v1161, v1148, v1152, v1151, v1150);	// L1380
    forward_node83(v1156, v1147, v1152, v1151, v1150);	// L1381
  }
}
    ...
    for (int v1180 = 0; v1180 < 8; v1180 += 2) {	// L1399
      for (int v1181 = 0; v1181 < 7; v1181 += 1) {	// L1400
        for (int v1182 = 0; v1182 < 7; v1182 += 1) {	// L1401
          ...
          float v1187 = ((v1179 + (v1178 * 8)) == 0 && v1176 == 0 && v1177 == 0) ? v1183 : v1186;	// L1406
          ...
          float v1194 = ((((-v1179) + (v1178 * -8)) + 127) == 0 && ((-v1176) + 2) == 0 && ((-v1177) + 2) == 0) ? v1193 : v1191;	// L1413
          ...
          float v1199 = ((v1179 + (v1178 * 8)) == 0 && v1176 == 0 && v1177 == 0) ? v1195 : v1198;	// L1419
          ...
          float v1205 = ((((-v1179) + (v1178 * -8)) + 127) == 0 && ((-v1176) + 2) == 0 && ((-v1177) + 2) == 0) ? v1204 : v1202;	// L1425
...
void forward_node90(
  ...
  for (int v1249 = 0; v1249 < 36864; v1249 += 1) {	// L1476
    ...
    forward_node96(v1246, v1259, v1252, v1251, v1250);	// L1487
    forward_node95(v1247, v1258, v1252, v1251, v1250);	// L1488
    forward_node94(v1245, v1257, v1255, v1254, v1251, v1253, v1250);	// L1489
    ...
    forward_node92(v1256, v1257, v1259, v1258, v1260, v1254, v1253, v1255);	// L1492
    ...
    for (int v1288 = 0; v1288 < 8; v1288 += 2) {	// L1522
      for (int v1289 = 0; v1289 < 7; v1289 += 1) {	// L1523
        for (int v1290 = 0; v1290 < 7; v1290 += 1) {	// L1524
          #pragma HLS pipeline II=1
          float v1291 = v1279[v1288][v1289][v1290];	// L1525
          float v1292 = v1283[v1288][v1289][v1290];	// L1526
          float v1293 = v1285[v1288][v1289][v1290];	// L1527
          float v1294 = (v1287 == 0) ? v1292 : v1293;	// L1528
          float v1295 = ((v1287 + (v1286 * 8)) == 0) ? v1291 : v1294;	// L1529
          float v1296 = v1282[v1287][v1289][v1290];	// L1530
          float v1297 = v1281[v1288][v1287];	// L1531
          float v1298 = v1296 * v1297;	// L1532
          float v1299 = v1295 + v1298;	// L1533
          v1285[v1288][v1289][v1290] = v1299;	// L1534
          float v1300 = v1280[v1288][v1289][v1290];	// L1535
          ...
          if ((((-v1287) + (v1286 * -8)) + 63) == 0) {	// L1539
            v1284[v1288][v1289][v1290] = v1303;	// L1540
          }
          float v1304 = v1279[(v1288 + 1)][v1289][v1290];	// L1542
          float v1305 = v1283[(v1288 + 1)][v1289][v1290];	// L1543
          float v1306 = v1285[(v1288 + 1)][v1289][v1290];	// L1544
          float v1307 = (v1287 == 0) ? v1305 : v1306;	// L1545
          float v1308 = ((v1287 + (v1286 * 8)) == 0) ? v1304 : v1307;	// L1546
          float v1309 = v1281[(v1288 + 1)][v1287];	// L1547
          float v1310 = v1296 * v1309;	// L1548
          float v1311 = v1308 + v1310;	// L1549
          v1285[(v1288 + 1)][v1289][v1290] = v1311;	// L1550
          float v1312 = v1280[(v1288 + 1)][v1289][v1290];	// L1551
          ...
          if ((((-v1287) + (v1286 * -8)) + 63) == 0) {	// L1555
            v1284[(v1288 + 1)][v1289][v1290] = v1315;	// L1556
          }
        }
      }
    }
...
void forward_node97(
  ...
  for (int v1366 = 0; v1366 < 2048; v1366 += 1) {	// L1618
    ...
    forward_node100(v1376, v1372, v1373, v1374, v1375, v1371, v1377, v1370);	// L1635
    forward_node99(v1377, v1364, v1369, v1368, v1367);	// L1636
    forward_node98(v1371, v1365, v1369, v1368, v1367);	// L1637
  }
}
    ...
    for (int v1396 = 0; v1396 < 8; v1396 += 2) {	// L1654
      for (int v1397 = 0; v1397 < 7; v1397 += 1) {	// L1655
        for (int v1398 = 0; v1398 < 7; v1398 += 1) {	// L1656
          #pragma HLS pipeline II=1
          float v1399 = v1387[v1396][v1397][v1398];	// L1657
          float v1400 = v1390[v1396][v1397][v1398];	// L1658
          float v1401 = v1391[v1396][v1397][v1398];	// L1659
          float v1402 = (v1395 == 0) ? v1400 : v1401;	// L1660
          float v1403 = ((v1395 + (v1392 * 8)) == 0 && v1393 == 0 && v1394 == 0) ? v1399 : v1402;	// L1661
          float v1404 = v1388[v1395][v1397][v1398];	// L1662
          ...
          float v1408 = v1387[(v1396 + 1)][v1397][v1398];	// L1667
          ...
          float v1412 = ((v1395 + (v1392 * 8)) == 0 && v1393 == 0 && v1394 == 0) ? v1408 : v1411;	// L1671
...
void forward_node106(
  float v1454[128][28][28],
  float v1455[128][28][28],
  float v1456[128][128][3][3],
  ...
  for (int v1459 = 0; v1459 < 36864; v1459 += 1) {	// L1725
    ...
    forward_node110(v1454, v1467, v1465, v1464, v1461, v1463, v1460);	// L1738
    forward_node109(v1456, v1466, v1464, v1463, v1462, v1465);	// L1739
    ...
    forward_node108(v1469, v1467, v1466, v1468, v1470, v1465, v1464, v1463);	// L1741
...
void forward_node113(
  ...
  float v1592[128][64][3][3],
  float v1593[64][56][56],
  ...
  for (int v1598 = 0; v1598 < 3584; v1598 += 1) {	// L1889
    ...
    forward_node114(v1593, v1592, v1601, v1594, v1595, v1596, v1597, v1600, v1599);	// L1896
  }
}
    ...
    for (int v1634 = 0; v1634 < 8; v1634 += 1) {	// L1931
      for (int v1635 = 0; v1635 < 8; v1635 += 1) {	// L1932
        for (int v1636 = 0; v1636 < 8; v1636 += 2) {	// L1933
          #pragma HLS pipeline II=1
          float v1637 = v1626[v1633][v1635][v1636];	// L1934
          float v1638 = v1625[v1634][v1633];	// L1935
          float v1639 = v1627[v1634][v1635][v1636];	// L1936
          float v1640 = v1628[v1634][v1635][v1636];	// L1937
          float v1641 = (v1633 == 0) ? v1639 : v1640;	// L1938
          float v1642 = v1637 * v1638;	// L1939
          float v1643 = v1641 + v1642;	// L1940
          v1628[v1634][v1635][v1636] = v1643;	// L1941
          ...
          if ((((-v1633) + (v1630 * -8)) + 63) == 0 && ((-v1632) + 2) == 0 && ((-v1631) + 2) == 0) {	// L1946
            v1629[v1634][v1635][v1636] = v1647;	// L1947
          }
          float v1648 = v1626[v1633][v1635][(v1636 + 1)];	// L1949
          float v1649 = v1627[v1634][v1635][(v1636 + 1)];	// L1950
          float v1650 = v1628[v1634][v1635][(v1636 + 1)];	// L1951
          float v1651 = (v1633 == 0) ? v1649 : v1650;	// L1952
          float v1652 = v1648 * v1638;	// L1953
          float v1653 = v1651 + v1652;	// L1954
          v1628[v1634][v1635][(v1636 + 1)] = v1653;	// L1955
          ...
          if ((((-v1633) + (v1630 * -8)) + 63) == 0 && ((-v1632) + 2) == 0 && ((-v1631) + 2) == 0) {	// L1960
            v1629[v1634][v1635][(v1636 + 1)] = v1657;	// L1961
          }
        }
      }
    }
...
void forward_node125(
  ...
  for (int v1702 = 0; v1702 < 28224; v1702 += 1) {	// L2012
    ...
    forward_node132(v1697, v1713, v1708, v1707, v1704, v1706, v1703);	// L2024
    forward_node131(v1696, v1712, v1707, v1706, v1705, v1708);	// L2025
    forward_node130(v1699, v1711, v1705, v1704, v1703);	// L2026
    forward_node129(v1698, v1710, v1705, v1704, v1703);	// L2027
    ...
    forward_node128(v1710, v1712, v1713, v1711, v1714, v1709, v1708, v1706, v1707);	// L2029
    forward_node127(v1714, v1700, v1705, v1704, v1703);	// L2030
    forward_node126(v1709, v1701, v1705, v1704, v1703);	// L2031
  }
}
    ...
    for (int v1733 = 0; v1733 < 8; v1733 += 1) {	// L2049
      for (int v1734 = 0; v1734 < 8; v1734 += 1) {	// L2050
        for (int v1735 = 0; v1735 < 8; v1735 += 2) {	// L2051
          #pragma HLS pipeline II=1
          float v1736 = v1725[v1733][v1734][v1735];	// L2052
          float v1737 = v1727[v1733][v1734][v1735];	// L2053
          float v1738 = v1728[v1733][v1734][v1735];	// L2054
          float v1739 = (v1732 == 0) ? v1737 : v1738;	// L2055
          float v1740 = ((v1732 + (v1730 * 8)) == 0 && v1731 == 0 && v1729 == 0) ? v1736 : v1739;	// L2056
          float v1741 = v1724[v1732][v1734][v1735];	// L2057
          float v1742 = v1726[v1733][v1732];	// L2058
          ...
          float v1747 = ((((-v1732) + (v1730 * -8)) + 63) == 0 && ((-v1731) + 2) == 0 && ((-v1729) + 2) == 0) ? v1746 : v1744;	// L2063
          v1728[v1733][v1734][v1735] = v1747;	// L2064
          float v1748 = v1725[v1733][v1734][(v1735 + 1)];	// L2065
          ...
          float v1752 = ((v1732 + (v1730 * 8)) == 0 && v1731 == 0 && v1729 == 0) ? v1748 : v1751;	// L2069
          float v1753 = v1724[v1732][v1734][(v1735 + 1)];	// L2070
          ...
          float v1758 = ((((-v1732) + (v1730 * -8)) + 63) == 0 && ((-v1731) + 2) == 0 && ((-v1729) + 2) == 0) ? v1757 : v1755;	// L2075
...
void forward_node133(
  ...
  for (int v1802 = 0; v1802 < 28224; v1802 += 1) {	// L2126
    ...
    forward_node135(v1810, v1812, v1809, v1811, v1813, v1806, v1808, v1807);	// L2142
...
void forward_node140(
  float v1919[64][56][56],
  float v1920[64][56][56],
  float v1921[64][56][56],
  float v1922[64][64][3][3],
  ...
  for (int v1926 = 0; v1926 < 28224; v1926 += 1) {	// L2270
    ...
    forward_node148(v1921, v1938, v1929, v1928, v1927);	// L2283
    forward_node147(v1923, v1937, v1929, v1928, v1927);	// L2284
    forward_node146(v1919, v1936, v1932, v1931, v1928, v1930, v1927);	// L2285
    forward_node145(v1922, v1935, v1931, v1930, v1929, v1932);	// L2286
    forward_node144(v1920, v1934, v1929, v1928, v1927);	// L2287
    ...
    forward_node143(v1935, v1934, v1936, v1938, v1937, v1933, v1939, v1932, v1931, v1930);	// L2289
    forward_node142(v1939, v1924, v1929, v1928, v1927);	// L2290
    forward_node141(v1933, v1925, v1929, v1928, v1927);	// L2291
  }
}
    ...
    for (int v1958 = 0; v1958 < 8; v1958 += 1) {	// L2309
      for (int v1959 = 0; v1959 < 8; v1959 += 1) {	// L2310
        for (int v1960 = 0; v1960 < 8; v1960 += 2) {	// L2311
          #pragma HLS pipeline II=1
          float v1961 = v1951[v1958][v1959][v1960];	// L2312
          float v1962 = v1952[v1958][v1959][v1960];	// L2313
          float v1963 = v1953[v1958][v1959][v1960];	// L2314
          float v1964 = (v1957 == 0) ? v1962 : v1963;	// L2315
          float v1965 = ((v1957 + (v1954 * 8)) == 0 && v1955 == 0 && v1956 == 0) ? v1961 : v1964;	// L2316
          float v1966 = v1949[v1957][v1959][v1960];	// L2317
          float v1967 = v1950[v1958][v1957];	// L2318
          ...
          float v1972 = ((((-v1957) + (v1954 * -8)) + 63) == 0 && ((-v1955) + 2) == 0 && ((-v1956) + 2) == 0) ? v1971 : v1969;	// L2323
          v1953[v1958][v1959][v1960] = v1972;	// L2324
          float v1973 = v1951[v1958][v1959][(v1960 + 1)];	// L2325
          ...
          float v1977 = ((v1957 + (v1954 * 8)) == 0 && v1955 == 0 && v1956 == 0) ? v1973 : v1976;	// L2329
          float v1978 = v1949[v1957][v1959][(v1960 + 1)];	// L2330
          ...
          float v1983 = ((((-v1957) + (v1954 * -8)) + 63) == 0 && ((-v1955) + 2) == 0 && ((-v1956) + 2) == 0) ? v1982 : v1980;	// L2335
...
void forward_node149(
  float v2023[64][64][3][3],
  float v2024[64][56][56],
  ...
  for (int v2028 = 0; v2028 < 28224; v2028 += 1) {	// L2388
    ...
    forward_node153(v2024, v2036, v2034, v2033, v2030, v2032, v2029);	// L2401
    forward_node152(v2023, v2035, v2033, v2032, v2031, v2034);	// L2402
    ...
    forward_node151(v2036, v2035, v2038, v2037, v2039, v2034, v2033, v2032);	// L2404
...
void forward(
  ...
  forward_node149(v2277, v2305, v2307, v2313, v2312);	// L2968
  forward_node140(v2314, v2306, v2308, v2278, v2319, v2318, v2315);	// L2969
  forward_node133(v2279, v2316, v2309, v2321, v2320);	// L2970
  forward_node125(v2280, v2322, v2317, v2311, v2310, v2323);	// L2971
  forward_node113(v2326, v2281, v2324, v2335, v2334, v2333, v2332);	// L2972
  forward_node106(v2336, v2327, v2282, v2338, v2337);	// L2973
  forward_node97(v2283, v2328, v2339, v2325, v2344, v2343, v2340);	// L2974
  forward_node90(v2284, v2341, v2329, v2346, v2345);	// L2975
  forward_node82(v2347, v2285, v2342, v2331, v2348, v2330);	// L2976
  forward_node75(v2351, v2349, v2286, v2358, v2357);	// L2977
  forward_node68(v2287, v2352, v2359, v2361, v2360);	// L2978
  forward_node59(v2353, v2288, v2350, v2362, v2367, v2366, v2363);	// L2979
  forward_node52(v2289, v2354, v2364, v2369, v2368);	// L2980
  forward_node44(v2290, v2365, v2370, v2356, v2355, v2371);	// L2981
  forward_node37(v2291, v2374, v2372, v2381, v2380);	// L2982
  forward_node30(v2382, v2292, v2375, v2384, v2383);	// L2983
  forward_node21(v2293, v2385, v2376, v2373, v2390, v2386, v2389);	// L2984
  forward_node14(v2294, v2387, v2377, v2392, v2391);	// L2985
  forward_node6(v2388, v2393, v2295, v2379, v2394, v2378);	// L2986
  ...
  forward_node0(v2296, v2518, v2519, v2275);	// L2989
}
